...
print_recommendations() {
    	# 快连
	printf "${yellow}推${purple}荐${blue}自${green}用${red}机${cyan}场: ${blue}→ ${blue}https://${white}user.${blue}vip${white}three.${blue}xyz/${white}register?${green}aff=${purple}1044562${reset}\n"
}
